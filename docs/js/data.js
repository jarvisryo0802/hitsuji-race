...
export const GOAT_GOAL_M     = 400;  // ここまで あるけたら ゴール（せいこうで ごほうび）
...
// しょうがいぶつの かんかくは docs/js/horse.js の decideGap() で ジャンプの
// たいくうじかんから けいさんする（かならず 1かいの ジャンプで こえられる
// ひろさを きほんに、たまに ひろい きゅうけいや タイトな れんぞくを まぜる）
export const HORSE_STAGES = [
  { m:0,   speed:170, h:[16, 22], w:[20, 26] },
  { m:100, speed:200, h:[20, 28], w:[24, 32] },
  { m:250, speed:235, h:[26, 34], w:[28, 38] },
  { m:450, speed:270, h:[30, 40], w:[32, 44] },
  { m:700, speed:310, h:[34, 46], w:[36, 50] },
];
